...
describe('env.js', function () {
  describe('getDeploymentEnv', function () {
    ...
    testOriginAndEnv(
      ...
      () => {
        throw new Error('no match on origin');
      },
      'webui.ipfs',
      1
    );
    testOriginAndEnv(
      'https://some-random-url',
      () => ({ redirected: false, url: 'https://some-random-url/webui' }),
      'webui.ipfs',
      1
    );
    ...
    testOriginAndEnv(
      'https://some-random-url.localhost:3333',
      () => ({ redirected: false, url: 'https://some-random-url.localhost:3333/webui' }),
      'local',
      1
    );
    ...
    testOriginAndEnv(
      ...
      () => ({
        redirected: true,
        url: 'http://localhost:5001/ipfs/bafybeiequgo72mrvuml56j4gk7crewig5bavumrrzhkqbim6b3s2yqi7ty/',
      }),
      'kubo',
      1
    );
    testOriginAndEnv(
      ...
      () => ({
        redirected: true,
        url: 'http://127.0.0.1:5002/ipfs/bafybeiequgo72mrvuml56j4gk7crewig5bavumrrzhkqbim6b3s2yqi7ty/',
      }),
      'kubo',
      1
    );
    testOriginAndEnv(
      ...
      () => ({
        redirected: true,
        url: 'https://some-random-url.localhost:3333/ipfs/bafybeiequgo72mrvuml56j4gk7crewig5bavumrrzhkqbim6b3s2yqi7ty/',
      }),
      'kubo',
      1
    );

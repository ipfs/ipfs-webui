...
jest.mock('multiaddr', () => (args) => ({ nodeAddress: () => args }))
jest.mock('hashlru', () => () => ({
...
describe('reactPeerLocationsFetch', () => {
  it.skip('should declare its dependencies', async () => {
    ...
    expect(createSelector).toHaveBeenNthCalledWith(1, 'selectRouteInfo', 'selectPeerLocationsShouldUpdate', 'selectIpfsConnected', expect.any(Function))
  })
...
describe('selectPeerLocationsForSwarm', () => {
  it.skip('should declare its dependencies', () => {
    createPeersLocationBundle()
    expect(createSelector).toHaveBeenNthCalledWith(2, 'selectPeers', 'selectPeerLocations', 'selectBootstrapPeers', 'selectIdentity', expect.any(Function))
  })
...
describe('selectPeersCoordinates', () => {
  it.skip('should declare its dependencies', () => {
    createPeersLocationBundle()
    expect(createSelector).toHaveBeenNthCalledWith(3, 'selectPeerLocationsForSwarm', expect.any(Function))
  })

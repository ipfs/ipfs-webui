...
const selectors = {
    ...
    selectIpfsConnected: createSelector('selectIpfsReady', 'selectNodeBandwidthLastSuccess', 'selectNodeBandwidthLastError', 
    /**
     ...
     * @returns {boolean}
     */
    (ipfsReady, lastSuccess, lastError) => ipfsReady && lastSuccess != null && lastSuccess > lastError),
    /**
     * @param {State} state
     */

...
export default (opts = {}) => {
  ...
  return {
    ...
    doFilesWrite: make(actions.WRITE, async (ipfs, root, filesOrPromise, wellFormed, id, { dispatch }) => {
      ...
      const { streams, totalSize } = wellFormed ? files : await filesToStreams(files)

...
export default composeBundles(createCacheBundle({
  cacheFn: bundleCache.set
}), appIdle({ idleTimeout: 5000 }), ipfsProvider, identityBundle, routesBundle, redirectsBundle, toursBundle, filesBundle(), exploreBundle(), configBundle, configSaveBundle, gatewayBundle, nodeBandwidthBundle, nodeBandwidthChartBundle(), peersBundle, peerLocationsBundle(), pinningBundle, notifyBundle, connectedBundle, retryInitBundle, experimentsBundle, ipfsDesktop, repoStats, cliTutorModeBundle, createAnalyticsBundle({}), ipnsBundle)

...
const selectors = {
    ...
    selectAnalyticsActionsToRecord: createSelector('selectIsIpfsDesktop', 'selectDesktopCountlyActions', 
    /**
...
const createAnalyticsBundle = ({ countlyUrl = 'https://countly.ipfs.io', countlyAppKey = pickAppKey(), appVersion = process.env.REACT_APP_VERSION, 
// @ts-ignore - declared but never used
appGitRevision = process.env.REACT_APP_GIT_REV, debug = false }) => {
    return {
        name: 'analytics',
        persistActions: [

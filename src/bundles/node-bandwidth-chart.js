...
function createNodeBandwidthChart(opts) {
    ...
    return {
        ...
        reactUpdateNodeBandwidthChartData: createSelector('selectNodeBandwidth', 'selectNodeBandwidthLastSuccess', 'selectNodeBandwidthEnabled', 'selectNodeBandwidthChartData', (bw, lastSuccess, enabled, chartData) => {
            if (!bw || !enabled)
                return;

    ...
    <Modal {...props} className={className} onCancel={onCancel}>
      <ModalBody title={t('bulkImportModal.title')} Icon={Icon}>
        ...
        <input
          ...
          onChange={onChange}
        />
        <Button onClick={selectFile} className="ma2 tc" bg="bg-teal">
        ...
        {validationError && <p className="mt2 red">{validationError}</p>}
      </ModalBody>
      ...
      <ModalActions>
        ...
        <Button className="ma2 tc" bg="bg-teal" disabled={isDisabled} onClick={onSubmit}>

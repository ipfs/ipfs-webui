...
class AddByPathModal extends React.Component {
    ...
    render() {
        const { t, tReady, onCancel, onSubmit, className, ...props } = this.props;
        ...
        <ModalBody title={t('addByPathModal.title')} Icon={Icon}>
          ...
          <input onChange={this.onChange} onKeyPress={this.onKeyPress} value={this.state.value} name='path' required placeholder={t('addByPathModal.importPathPlaceholder')} className={`input-reset charcoal ba b--black-20 br1 pa2 mb2 db w-90 center focus-outline ${this.inputClass}`} type='text'/>

          <input onChange={this.onChange} onKeyPress={this.onKeyPress} value={this.state.name} placeholder={t('addByPathModal.namePlaceholder')} name='name' className='input-reset charcoal ba b--black-20 br1 pa2 mb2 db w-90 center focus-outline' type='text'/>
        </ModalBody>

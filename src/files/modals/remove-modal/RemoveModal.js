  ...
  return (
    <Modal {...props} className={className} onCancel={onCancel}>
        ...
        <div className="charcoal w-100 center tl">
          ...
          {isLocallyPinned && (
            <div>
              <Checkbox
                className="mr1"
                checked={shouldRemoveLocalPin}
                onChange={handleLocalPinRemoval}
                label={t('removeModal.checkboxRemoveLocalPin')}
              />
            </div>
          )}
          {isRemotelyPinned && (
            <div className="mt1">
              <Checkbox
                className="mr1"
                checked={shouldRemoveRemotePin}
                onChange={handleRemotePinRemoval}
                label={t('removeModal.checkboxUnpinFromServices')}
              />
            </div>
          )}
        </div>
      ...
      <ModalActions>
        ...
        <Button className="ma2 tc" bg="bg-red" onClick={handleRemove}>

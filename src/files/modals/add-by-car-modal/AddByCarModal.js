  ...
  return (
    <Modal className={className} onCancel={onCancel}>
      <ModalBody title={t('addByCarModal.title')} Icon={Icon}>
        ...
        <label htmlFor="import-car-file-name" className="mt0 f7 center charcoal-muted tl w-90">
          {t('addByCarModal.renameImportPath')}
        </label>
        <input
        ...
        />
        <Button className="ma2 tc" bg="bg-teal" onClick={onAddFileButtonClick}>
          {t('addByCarModal.selectCARButtonText')}
        </Button>
      ...
      <ModalActions>
        ...
        <Button className="ma2 tc" bg="bg-teal" disabled={isDisabled} onClick={onSubmitFile}>

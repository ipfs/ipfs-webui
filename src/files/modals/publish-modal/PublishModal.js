...
export const PublishModal = ({
        ...
        <div>
          ...
          <div className="flex center mb2 relative">
            <input
              ...
              readOnly
              className={
                'input-reset flex-grow-1 charcoal-muted ba b--black-20 br1 pa2 focus-outline'
              }
            ...
            <div
              className="absolute h2 pl2 flex items-center"
              style={{
                right: '4px',
                top: '50%',
                transform: 'translateY(-50%)',
                background:
                  'linear-gradient(90deg, rgba(255, 255, 255, 0.35), #ffffff 10%, #ffffff 100%)',
              }}
            >
              {copied ? (
                <>
          ...
          {ipnsKeys.map(key => (
            ...
            >
              <Radio
                ...
                checked={key.name === selectedKey.name}
                label={key.name}
  ...
  return (
    <Modal {...props} className={className} onCancel={onLeave}>
      ...
      <ModalActions>
        {link ? (
          <Button className="ma2 tc ml-auto" onClick={onLeave}>
            {t('app:actions.done')}
          </Button>
        ) : (
          <>

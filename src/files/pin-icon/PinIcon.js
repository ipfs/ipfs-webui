...
const PinningIcon = ({ t, isFailedPin, isPendingPin, isRemotePin, pinned }) => {
  if (isFailedPin) {
    return (
      <div
        className="br-100 o-70"
        title={t('pinningFailedClickToDismiss')}
    ...
    return (
      <div
        className="br-100 PendingAnimation"
        title={t('pinningRemotely')}
        style={{ width: '2rem', height: '2rem' }}
      >
    ...
    return (
      <div
        className="br-100 hide-child"
        title={t('app:actions.setPinning')}
        style={{ width: '2rem', height: '2rem' }}
      >

  ...
  switch (type) {
    ...
    case 'pdf':
      return (
        <Drag {...props}>
          <object
            className="FilePreviewPDF w-100"
            data={safeSubresourceGwUrl(src)}
          ...
          >
            ...
            <a
              ...
              className="underline-hover navy-muted"
            >
              {t('downloadPDF')}
            </a>
          </object>
    ...
    default: {
          ...
          <p>
            {availableGatewayUrl === publicGateway ? (
              <Trans i18nKey="openWithPublicGateway" t={t}>
                Try opening it instead with your{' '}
                <a
                  href={src}
                  download
                  target="_blank"
      ...
      return (
        <>
          <pre className={`${className} overflow-auto monospace`}>{content}</pre>
          {hasMoreContent && (
            <div className="w-100 flex items-center justify-center">
              <p>
                <Trans i18nKey="previewLimitReached" t={t}>
                  This preview is limited to 10 KiB. Click the download button to access the full
                  file.
                </Trans>
              </p>
              <p>

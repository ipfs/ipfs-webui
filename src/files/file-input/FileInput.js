...
const AddButton = withTranslation('app')(({ t, onClick }) => (
  <Button
    id="import-button"
    bg="bg-navy"
    color="white"
  ...
  >
    <span>
      <span className="aqua">+</span> {t('actions.import')}
    </span>
  </Button>
));
      ...
      <div className={this.props.className}>
        <Dropdown>
          ...
          <DropdownMenu top={3} open={this.state.dropdown} onDismiss={this.toggleDropdown}>
            ...
            <Option
              onClick={this.onAddByCar}
              id="add-by-car"
              onCliTutorMode={() => this.onCliTutorMode(cliCmdKeys.FROM_CAR)}
              isCliTutorModeEnabled={isCliTutorModeEnabled}
            >

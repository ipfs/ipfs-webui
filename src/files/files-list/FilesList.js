...
export const FilesList = ({
  ...
  onShare, onSetPinning, selected, onSelect, onInspect, doFilesMove, onDownload, onRemove, onRename, onNavigate, onRemotePinClick, onAddFiles, onMove, doFetchRemotePins, doDismissFailedPin, handleContextMenuClick, t
}) => {

import React, { useRef, useState, useCallback, useEffect, type FC, type MouseEvent } from 'react'
...
const FilesGrid = ({
  ...
  const keyHandler = useCallback((e: KeyboardEvent) => {
    ...
    const focusedFile = focusedRef.current == null ? null : files.find(el => el.name === focusedRef.current)

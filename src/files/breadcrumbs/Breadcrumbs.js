  ...
  return (
    <span className="dib pv1 pr1" ref={drop}>
      <button
        ...
        onClick={() => onClick({ path: link.path })}
...
const Breadcrumbs = ({
  ...
  useEffect(() => {
    ...
    const newOverflows = a
      ? a.offsetHeight < a.scrollHeight || a.offsetWidth < a.scrollWidth
      : false;
  ...
  return (
    <nav
      ...
      className={classNames(
        'Breadcrumbs flex items-center sans-serif overflow-hidden sticky top-0',
        className
      )}
      {...props}
    >

    ...
    return (
      <div
        className={classNames(
          'sans-serif bt w-100 pa3 ph4-l selectedActions',
          className,
          animateOnStart && 'selectedActionsAnimated'
        )}
      ...
      >
        <div className="flex items-center justify-between">
          <div className="w5-l">
            <div className="flex items-center">
              <div className="mr3 relative f3 fw6 flex-shrink-0 dib br-100" style={styles.count}>
                <span className="absolute" style={styles.countNumber}>
                  {count}
                </span>
              </div>
              <div className="dn db-l f6">
                <p className="ma0">{t('filesSelected', { count })}</p>
                <p className="ma0 mt1" style={styles.size}>
          ...
          >
            ...
            <button
              role="menuitem"
              className={classNames('tc mh2', classes.action(isMfs))}
            ...
            <button
              role="menuitem"
              className={classNames('tc mh2', classes.action(isSingle))}
              onClick={isSingle ? setPinning : null}
            >
            ...
            <button
              role="menuitem"
              className={classNames('tc mh2', classes.action(isSingle && isMfs))}
          ...
          <div>
            <button onClick={unselect} className="flex items-center justify-end f6 charcoal">
              ...
              <GlyphSmallCancel
                onClick={unselect}
                className="fill-charcoal w1 o-70"
                viewBox="37 40 27 27"
              />
            </button>
          </div>

...
export const AsyncRequestLoader = ({ asyncActive }) => (<div title={asyncActive ? 'Fetching data...' : null} className={asyncActive ? 'o-100' : 'o-0'} style={{ transition: 'opacity 500ms linear' }}>
    <Loader />
  </div>)

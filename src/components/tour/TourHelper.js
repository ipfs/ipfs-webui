...
export const TourHelper = ({ doEnableTours, className = '', size = 23, t }) => {
  ...
  return (<button className={`dib mr1 ml4-m pointer ${className}`} onClick={handleClick} aria-label={t('startTourHelper')}>
...
export default connect('doEnableTours', withTranslation('app')(TourHelper))

...
const getButtonClassName = (
  {
    ...
    danger,
    disabled,
  }: Pick<ButtonProps, 'fill' | 'bg' | 'color' | 'danger' | 'disabled'>,
...
const Button: React.FC<ButtonProps> = givenProps => {
  const { className, minWidth, children, style, buttonType, type, danger, ...props } = {
    ...defaultProps,
    ...givenProps,
  };
  return (
    <button
      ...
      className={classNames(
        'Button transition-all sans-serif dib v-mid fw5 nowrap lh-copy bn br1 pa2 focus-outline',
        className,
        getButtonClassName(props, type)
      )}

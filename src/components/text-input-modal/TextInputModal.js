...
class TextInputModal extends React.Component {
    ...
    render() {
        const { t, onCancel, onChange, onInputChange, mustBeDifferent, onSubmit, className, Icon, submitText, validate, defaultValue, description, title, error, loading, ...props } = this.props;
        ...
        <ModalBody title={title} Icon={Icon}>
          ...
          <input onChange={this.onChange} onKeyPress={this.onKeyPress} value={this.state.value} required className={`input-reset charcoal ba b--black-20 br1 pa2 mb2 db w-90 center focus-outline ${this.inputClass}`} type='text'/>
        </ModalBody>

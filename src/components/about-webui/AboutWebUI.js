    ...
    <Box>
      ...
      <ul className="pl3">
        <Trans i18nKey="welcomeInfo.paragraph1" t={t}>
          <li className="mb2">
            <a href="#/" className="link blue u b">
              Check your node status
            </a>
            , including how many peers you're connected to, your storage and bandwidth stats, and
            more
          </li>
        </Trans>
        <Trans i18nKey="welcomeInfo.paragraph2" t={t}>
          <li className="mb2">
            <a href="#/files" className="link blue u b">
              View and manage files
            </a>{' '}
            in your IPFS repo, including drag-and-drop file import, easy pinning, and quick sharing
            and download options
          </li>
        </Trans>
        <Trans i18nKey="welcomeInfo.paragraph3" t={t}>
          <li className="mb2">
            <a href="#/explore" className="link blue b">
        ...
        <Trans i18nKey="welcomeInfo.paragraph4" t={t}>
          <li className="mb2">
            <a href="#/peers" className="link blue b">
              See who's connected to your node
            </a>
            , geolocated on a world map by their IP address
          </li>
        </Trans>
        <Trans i18nKey="welcomeInfo.paragraph5" t={t}>
          <li className="mb2">
            <a href="#/settings" className="link blue b">
              Review or edit your node settings
            </a>{' '}
            &mdash; no command line required
          </li>
        </Trans>
        <Trans i18nKey="welcomeInfo.paragraph6" t={t}>
          <li className="f5">
            <a
              ...
              className="link blue b"
              target="_blank"
              rel="noopener noreferrer"
            >
              Check this app's source code
            </a>{' '}
            to{' '}
            <a
            ...
            or make a contribution, and make IPFS better for everyone!
          </li>
        </Trans>
      </ul>
    </Box>

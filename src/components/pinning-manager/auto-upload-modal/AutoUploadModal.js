  ...
  return (
    <Modal {...props} className={className} onCancel={onLeave} style={{ maxWidth: '34em' }}>
      ...
      <ModalActions justify="center">
        <Button className="ma2 tc" bg="bg-teal" onClick={onToggle}>
...
export default connect('doSetAutoUploadForService', withTranslation('settings')(AutoUploadModal));

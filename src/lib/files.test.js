...
it('should get a subdomain gateway url', async () => {
  ...
  const shareableLink = await getShareableLink(
    files,
    DEFAULT_PATH_GATEWAY,
...
it('should get a path gateway url', async () => {
  ...
  const veryLongCidv1 =
    'bagaaifcavabu6fzheerrmtxbbwv7jjhc3kaldmm7lbnvfopyrthcvod4m6ygpj3unrcggkzhvcwv5wnhc5ufkgzlsji7agnmofovc2g4a3ui7ja';

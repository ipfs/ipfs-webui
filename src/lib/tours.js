...
export const appTour = {
  getSteps: ({ t }) => [
    {
      content: (
        <div className="montserrat white">
      ...
      content: (
        <div className="montserrat charcoal">
          ...
          <Trans i18nKey="tour.step3.paragraph2" t={t}>
            <p className="tl f6">
              Click on <code>Advanced</code> to see more info such as the gateway URL and addresses.
            </p>
          </Trans>
        </div>
      ),
      ...
      content: (
        <div className="montserrat charcoal">
          ...
          <Trans i18nKey="tour.step1.paragraph1" t={t}>
            <p className="tl f6">
              This is where the files on your{' '}
              <a
                className="teal link"
                href="https://docs.ipfs.tech/concepts/file-systems/"
                rel="noopener noreferrer"
                target="_blank"
              >
                Mutable File System (MFS)
              </a>{' '}
              live. You can add files or folders and manage them from this page.
            </p>
          </Trans>
          <p className="tl f6">{t('tour.step1.paragraph2')}</p>
        </div>
      ...
      content: (
        <div className="montserrat charcoal">
          ...
          <Trans i18nKey="tour.step3.paragraph3" t={t}>
            <p className="tl f6">
              If you want to add something that is already on IPFS, you can import it to your MFS by
              passing its{' '}
              <a
                className="teal link"
      ...
      content: (
        <div className="montserrat charcoal">
          ...
          <Trans i18nKey="tour.step3.paragraph1" t={t}>
            <p className="tl f6">
              If you have accounts with third-party remote pinning services, add them here so you
              can pin/unpin items to those services directly from the Files screen. You can learn
              more about third-party pinning services in the{' '}
              <a
                className="teal link"
      ...
      content: (
        <div className="montserrat charcoal">
          ...
          <Trans i18nKey="tour.step4.paragraph1" t={t}>
            <p className="tl f6">
              You can change the language of the Web UI. If your preferred language isn't available,
              head over our project page in{' '}
              <a
                className="teal link"

    ...
    <Box className="mt3 pa3">
      ...
      <p className="mw6 mr2 lh-copy charcoal f6">
        <Trans i18nKey="bandwidthStatsDisabled" t={t}>
          ...
          <a className="link blue" href="#/settings">
            Settings
          </a>
          . Then, you need to restart the IPFS daemon to apply the changes.
        </Trans>
      </p>

      <Shell className="mw6">
        <code className="db">
          <b className="no-select">$ </b>ipfs config --json Swarm.DisableBandwidthMetrics false
        </code>
      </Shell>
    </Box>
  );

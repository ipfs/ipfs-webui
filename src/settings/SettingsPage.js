  ...
  <div data-id="SettingsPage" className="mw9 center">
        ...
        <div className="lh-copy charcoal">
          ...
          <Trans i18nKey="apiDescription" t={t}>
            <p>
              ...
              <a
                className="link blue"
                href="https://github.com/ipfs/kubo/blob/master/docs/config.md#addresses"
                target="_blank"
                rel="noopener noreferrer"
              >
                custom Kubo RPC API address
              </a>
      ...
      <div className="lh-copy charcoal">
        <Trans i18nKey="publicPathGatewayDescription" t={t}>
          <p>
            ...
            <a
              className="link blue"
              href="https://docs.ipfs.tech/concepts/ipfs-gateway/#path"
              target="_blank"
              rel="noopener noreferrer"
            >
              Path Gateway
            </a>{' '}
            for generating shareable links for CIDs that exceed the 63-character DNS limit.
          </p>
        </Trans>
        <PublicGatewayForm />
      </div>
    ...
    <Box className="mb3 pa4-l pa2">
      ...
      <p className="ma0 mr2 lh-copy charcoal f6">
        {t('ipnsPublishingKeys.description')}&nbsp;
        <a
          className="link blue"
          target="_blank"
          rel="noopener noreferrer"
          href="https://docs.ipfs.tech/concepts/glossary/#ipns"
        >
          {t('learnMoreLink')}
        </a>
      </p>
    ...
    <Box className="mb3 pa4-l pa2 joyride-settings-pinning">
      ...
      <p className="ma0 mr2 lh-copy charcoal f6">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          href="https://docs.ipfs.tech/how-to/work-with-pinning-services/"
        >
          {t('learnMoreLink')}
        </a>
      </p>
    ...
    <Box className="mb3 pa4-l pa2 joyride-settings-tutormode">
      <div className="charcoal">
        ...
        <Checkbox
          ...
          checked={isCliTutorModeEnabled}
          label={<span className="f5 lh-copy">{t('cliToggle.label')}</span>}
        />
        <Trans i18nKey="cliDescription" t={t}>
          <p className="f6 mv2">
            Enable this option to display a "view code"{' '}
            <StrokeCode
              className="dib v-mid icon mh1 fill-charcoal"
              viewBox="14 20 70 66"
              style={{ height: 24 }}
            />{' '}
            icon next to common IPFS commands. Clicking it opens a modal with that command's CLI
            code, so you can paste it into the IPFS command-line interface in your terminal.
          </p>
        </Trans>
      </div>
    </Box>
...
const SettingsInfo = ({
  ...
  if (!isIpfsConnected) {
    return <p className="ma0 lh-copy charcoal f5 mw7">{t('ipfsDaemonOffline')}</p>;
  } else if (!config) {
    return (
    ...
    return (
      <p className="ma0 lh-copy red f5 mw7">
        <Trans i18nKey="settingsHaveChanged" t={t}>
          The settings have changed, please click <strong>Reset</strong> to update the editor
          contents
        </Trans>
      </p>
    );
  ...
  return (
    <p className="ma0 mr2 lh-copy charcoal f5">
      ...
      <a
        href="https://github.com/ipfs/kubo/blob/master/docs/config.md"
        rel="noopener noreferrer"
        target="_blank"
        className="link blue"
      >
...
export class SettingsPageContainer extends React.Component {
  ...
  render() {
    ...
    const { hasErrors, hasLocalChanges, hasExternalChanges, editableConfig, editorKey } =
      this.state;

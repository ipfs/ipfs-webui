      ...
      <Table responsive className={className}>
        <thead>
          <tr>
            ...
            <th className='filelist-name narrow'>Name</th>
            <th className='id-cell narrow'>ID</th>
        ...
        {files ? files.map(function (file) {
          ...
          var dagLink = function () { ipfsapp.link('/DAG/ipfs/' + file.id) }
          return (

...
var FileList = require('./js/filelist.jsx')
var LocalStorage = require('./js/localStorage.js')
var $ = require('jquery')
  ...
  <div className='row'>
    <div className='col-sm-10 col-sm-offset-1'>
      <ul className='nav nav-tabs'>
        <li role='presentation' className={tab === 'files' ? 'active' : ''}>
          <a onClick={ function () { ipfsapp.link('files') } } href='#/files'>Files</a>
        </li>
        <li role='presentation' className={tab === 'pinned' ? 'active' : ''}>
          <a onClick={ function () { ipfsapp.link('pinned') } }>Pinned</a>
        </li>
        <li role='presentation' className={tab === 'all' ? 'active' : ''}>
          <a onClick={ function () { ipfsapp.link('all') } }>All</a>
        </li>
      </ul>
